...
assert(version === '5.2.7', `unexpected manifest version: ${version}`);
...
assert(popup.includes('openTransfusionProtocol')
    ...
    && transfusionHtml.includes('office-templates.js?v=5.2.7')
    && transfusionHtml.includes('office-export.js?v=5.2.7')
